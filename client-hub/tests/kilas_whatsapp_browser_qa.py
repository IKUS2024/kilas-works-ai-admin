...
with sync_playwright() as p:
    ...
    expect(page.locator('[data-playbook-context]')).to_have_count(0)
    expect(page.locator('[data-linked-jobs]')).to_have_count(0)
    ...
    browser.close()
print('Phase 8 mobile owner Inbox PASS: channel, takeover, official manual reply, resume, Jobs kept separate, tenant denial, no overflow/JS errors')
