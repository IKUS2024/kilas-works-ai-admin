...
CREATE TABLE IF NOT EXISTS finance_invoices (
 id INTEGER PRIMARY KEY AUTOINCREMENT, business_id INTEGER NOT NULL REFERENCES businesses(id), customer_id INTEGER NOT NULL,
 ...
 notes TEXT, created_by_user_id INTEGER REFERENCES users(id), created_at TEXT NOT NULL, updated_at TEXT NOT NULL,
 voided_at TEXT, voided_by_user_id INTEGER REFERENCES users(id), UNIQUE(business_id,id),
...
CREATE TABLE IF NOT EXISTS finance_invoice_items (
 id INTEGER PRIMARY KEY AUTOINCREMENT, business_id INTEGER NOT NULL REFERENCES businesses(id), invoice_id INTEGER NOT NULL,
 description TEXT NOT NULL, quantity INTEGER NOT NULL CHECK(typeof(quantity)='integer' AND quantity>0), unit_price_minor INTEGER NOT NULL CHECK(typeof(unit_price_minor)='integer' AND unit_price_minor>=0), created_at TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS finance_invoice_payments (
 id INTEGER PRIMARY KEY AUTOINCREMENT, business_id INTEGER NOT NULL REFERENCES businesses(id), invoice_id INTEGER NOT NULL,
 amount_minor INTEGER NOT NULL CHECK(typeof(amount_minor)='integer' AND amount_minor>0), paid_on TEXT NOT NULL,
 account_id INTEGER NOT NULL, category_id INTEGER NOT NULL,
 ledger_transaction_id INTEGER UNIQUE REFERENCES finance_transactions(id), note TEXT,
 idempotency_key TEXT NOT NULL, created_by_user_id INTEGER REFERENCES users(id), created_at TEXT NOT NULL,
...
ALTER TABLE finance_transactions ADD COLUMN customer_id INTEGER REFERENCES finance_customers(id);
