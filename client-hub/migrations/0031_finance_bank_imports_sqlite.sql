...
CREATE TABLE IF NOT EXISTS finance_bank_imports (
 ...
 business_id INTEGER NOT NULL REFERENCES businesses(id), account_id INTEGER NOT NULL,
 ...
 imported_by_user_id INTEGER NOT NULL REFERENCES users(id), created_at TEXT NOT NULL, updated_at TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS finance_bank_rows (
 id INTEGER PRIMARY KEY AUTOINCREMENT, business_id INTEGER NOT NULL REFERENCES businesses(id), import_id INTEGER NOT NULL,
 ...
 matched_transaction_id INTEGER, created_transaction_id INTEGER,
