...
WHERE scope_key='BUSINESS'
  ...
  AND EXISTS (
    ...
    WHERE p.business_id=finance_category_workspace_settings.business_id
      AND p.category_id=finance_category_workspace_settings.category_id
  ...
  AND NOT EXISTS (
    ...
    WHERE t.business_id=finance_category_workspace_settings.business_id
      AND t.category_id=finance_category_workspace_settings.category_id
  )
  AND NOT EXISTS (
    ...
    JOIN finance_branch_workspaces w
     ...
     AND w.workspace_type='BUSINESS'
    WHERE b.business_id=finance_category_workspace_settings.business_id
      AND b.category_id=finance_category_workspace_settings.category_id
  )
  AND NOT EXISTS (
    ...
    JOIN finance_branch_workspaces w
     ...
     AND w.workspace_type='BUSINESS'
    WHERE r.business_id=finance_category_workspace_settings.business_id
      AND r.category_id=finance_category_workspace_settings.category_id
  );
