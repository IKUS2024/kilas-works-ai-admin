...
CREATE TABLE IF NOT EXISTS finance_recurring_expenses (
 ...
 is_active BOOLEAN NOT NULL DEFAULT TRUE, created_by_user_id BIGINT REFERENCES users(id),
...
CREATE TABLE IF NOT EXISTS finance_recurring_postings (
 id BIGSERIAL PRIMARY KEY, business_id BIGINT NOT NULL REFERENCES businesses(id), recurring_expense_id BIGINT NOT NULL,
 scheduled_on TEXT NOT NULL, ledger_transaction_id BIGINT UNIQUE REFERENCES finance_transactions(id), created_at TEXT NOT NULL,
